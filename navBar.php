<?php
	...
	$dev ="";
	$validUser = "";
	if(strcasecmp($status,"dev")==0){ $dev = '<li><a href="developerConsole.php">Dev Console</a></li>';}

	if($email != NULL){
		$validUser = '        <div id="navbar" class="navbar-collapse collapse">
	...
	<ul class="nav navbar-nav">
	  ...
	  <form class="navbar-form navbar-right" method="post">
		"<span style ="color: #5CB75C; padding-right:5px;">'.$username.'</span><button type="submit" name="myAccount" class="btn-sm btn-success">Account</button>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="mainPage.php">OS Homework</a>
        </div>
		'.$validUser.'
	</div><!--/.navbar-collapse -->
  </div>
...
if (!function_exists('generateNavBarRegister')){

function generateNavBarRegister(){
